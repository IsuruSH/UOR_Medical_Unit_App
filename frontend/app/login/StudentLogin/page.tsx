...
const page: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-login-baround flex flex-col justify-center items-center">
      <div>
        <LoginHeader/>
      </div>
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        <div className="text-center">
          ...
          <h1 className="text-2xl font-bold mb-4 text-left">Student Sign In</h1>
        </div>
